...
colnames(happiness)[6] <- "economy"
colnames(happiness)[7] <- "family"
colnames(happiness)[8] <- "health"
colnames(happiness)[10] <- "trust"
colnames(happiness)[9] <- "freedom"
```

```{r include=FALSE}
countries$Country = setNames(c('Ivory Coast'), c('Cote d\'Ivoire'))[countries$Country] 
